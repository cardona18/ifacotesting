# -*- coding: utf-8 -*-
# © <2016> <
# Luis Alfredo Valencia (lavalencia@grupoifaco.com.mx)>
...
class stock_move(models.Model):
    ...
    quantity_done = fields.Float('Quantity Done', compute='_quantity_done_compute', digits=0, inverse='_quantity_done_set')
    ...
    def action_show_details(self):
        ...
        return {
            ...
            'context': dict(
                ...
                show_field= self.picking_type_id.code
            ),
        }
